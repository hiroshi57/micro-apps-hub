...
export default async function MemoryCardProPage({
  searchParams,
}: {
  ...
  const purchased = user ? await hasPurchased(user.id, 'memory-card') : false;
  ...
  if (!purchased) {
    return (
      <main className="min-h-screen bg-gray-950 text-white flex items-center justify-center">
        <div className="text-center max-w-md p-8">
          <div className="text-6xl mb-4">🃏</div>
          <h1 className="text-3xl font-bold mb-2">記憶カード Pro</h1>
          <p className="text-gray-400 mb-6">最大40枚・カスタム画像で記憶力の限界に挑む</p>
          <ul className="text-left text-sm text-gray-300 mb-8 space-y-2">
            <li className="flex items-center gap-2"><span className="text-pro-400">\u2605</span> 最大20ペア(40枚)</li>
            <li className="flex items-center gap-2"><span className="text-pro-400">\u2605</span> 10種テーマ</li>
            <li className="flex items-center gap-2"><span className="text-pro-400">\u2605</span> カスタム画像アップロード</li>
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white flex flex-col items-center py-8 px-4">
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold">🃏 記憶カード Pro</h1>
      ...
      <div className="text-center max-w-sm">
        ...
        <p className="text-gray-400 mb-8">最大40枚・カスタム画像で記憶力の限界に挑む</p>
        <div className="grid gap-3">
          <div className="bg-white/5 rounded-xl px-4 py-3 text-left text-sm text-gray-300 flex items-center gap-2"><span className="text-pro-400">\u2605</span> 最大20ペア(40枚)</div>
          <div className="bg-white/5 rounded-xl px-4 py-3 text-left text-sm text-gray-300 flex items-center gap-2"><span className="text-pro-400">\u2605</span> 10種テーマ</div>
          <div className="bg-white/5 rounded-xl px-4 py-3 text-left text-sm text-gray-300 flex items-center gap-2"><span className="text-pro-400">\u2605</span> カスタム画像アップロード</div>
          <div className="bg-white/5 rounded-xl px-4 py-3 text-left text-sm text-gray-300 flex items-center gap-2"><span className="text-pro-400">\u2605</span> 2人対戦モード</div>

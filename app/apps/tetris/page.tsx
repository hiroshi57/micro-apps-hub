    ...
    <main className="min-h-screen bg-gray-950 text-white flex flex-col items-center py-8 px-4">
      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="relative">
          ...
          {showProWall && (
            <div className="absolute inset-0 bg-gray-950/90 backdrop-blur-sm rounded-xl flex flex-col items-center justify-center text-center p-6">
              <div className="text-5xl mb-4">🔒</div>
              <h2 className="text-2xl font-bold mb-2">レベル6以降は Pro</h2>
              <p className="text-gray-400 text-sm mb-6">無制限レベル・10テーマ・オンラインランキング</p>
              <Link href="/apps/tetris/pro"
                className="bg-gradient-to-r from-pro-600 to-pro-500 text-white font-bold px-8 py-3 rounded-full text-lg">
                ¥480 で Pro を購入
              </Link>
              <button onClick={restart} className="mt-3 text-gray-500 text-sm hover:text-white transition-colors">
                最初からやり直す
              </button>
            </div>
          )}
